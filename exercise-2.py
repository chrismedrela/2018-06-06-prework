...
def calculate_discount_percentage(customer):
    ...
    if customer.first_purchase_date is not None and customer.first_purchase_date <= now - year:
        discount.append(10)

    if customer.first_purchase_date is not None and customer.first_purchase_date <= now - 5 * year:
        discount.append(12)

    if customer.first_purchase_date is not None and customer.first_purchase_date <= now - 10 * year:
        discount.append(20)
